...
for x in iter(tsharkProcess.stdout.readline, ""):
    ...
    if 'layers' in y and 'tcp' in y['layers'] and 'http' in y['layers'] and 'http_http_content_length' in y['layers']['http']:
        ...
        d = {
            ...
            "tcp.analysis.initial_rtt": [y['layers']['tcp']['tcp_tcp_analysis_initial_rtt']],
            ...
            "tcp.flags.ns": [1.0 if is_ns_flag_set(y['layers']['tcp']['tcp_tcp_flags']) else 0.0],
            ...
            "tcp.urgent_pointer": [norm.cdf([float(y['layers']['tcp']['tcp_tcp_urgent_pointer'])])],
            ...
            "eth.src.lg": [y['layers']['eth']['eth_eth_src_lg']],
            "eth.src_not_group": [0.0],

            "arp.isannouncement": [0.0],
        }
